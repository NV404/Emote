          ...
          <div>
            <div className="mt-20 px-8 flex justify-evenly">
              <div className="w-96 max-h-56 bg-white hidden rounded-xl shadow-xl overflow-hidden lg:flex lg:flex-col">
                <Link href="/Profile" className="w-auto"><a className="w-auto"><button className="w-full bg-purple-500 px-10 py-4 text-white uppercase">Profile</button></a></Link>
                <Link href="/upload" className="w-auto"><a className="w-auto"><button className="w-full bg-blue-500 px-10 py-4 text-white uppercase">Upload Post</button></a></Link>
              ...
              <div className="mx-3 flex flex-col w-full lg:w-2/5">
                <Link href="/upload">
                  <a>
                <div className="w-full m-auto flex flex-col justify-center items-center px-4 py-3 bg-white text-gray-400 rounded-lg shadow-lg tracking-wide uppercase border-2 border-purple-700 cursor-pointer hover:bg-purple-700 hover:text-white lg:m-0 lg:h-20">
              ...
              <div className="w-96 self-start bg-white hidden rounded-xl shadow-xl flex-col lg:flex">
                ...
                {UserDetails == null ?
                  ...
                  UserDetails.map(user => (
                    <Link href={`/User/${user.ProfileImage.username}`}>
                      <a>
                    <div
